...
const DeleteComponent = ({ className, id, onClose, onDelete, }: IDeleteProps) => {
  return <Modal open={!!id} onClose={onClose} title="Удалить">
    <div className={className}>
      ...
      <div className="footer">
        ...
        <Button onClick={() => onDelete(id!)} type="primary" textAlign="center">
          Удалить
        </Button>
      </div>
    </div>
