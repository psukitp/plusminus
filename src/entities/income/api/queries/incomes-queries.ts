...
import { IncomesRecord, IncomesByCategoryRecord, IncomesThisMonth, IncomesLastMonthes } from "@entities/income/model"
...
const fecthIncomesSum = async (): Promise<Omit<IncomesThisMonth, "loading">> => {
